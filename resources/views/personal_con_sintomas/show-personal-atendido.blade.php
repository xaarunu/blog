<x-app-layout>
    ...
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Personal con Sintomas Atendidos') }}
        </h2>
    </x-slot>
    @section('css')
        ...
        <div class="mx-auto sm:px-6 lg:px-8" style="width:80rem;">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-6 " style="width:100%;">
                <table id="data-table" class="stripe hover translate-table"
                    ...
                    <tbody>
                        @foreach ($Personal_sintomas_atendido as $personal)
                        <tr>
                            ...
                            <td class="none">
                                <div class="flex justify-center rounded-lg text-sm" role="group">
                                    <button class="mx-1 mt-3 border-right">
                                        <a href="{{ route('incapacidades.create',['rpe' => $personal->rpe]) }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded imprimirBtn">
                                            Generar incapacidad
                                        </a>
                                    </button>
                                </div>
...
<script>
    ...
    function filter() {
        ...
        fetch(SITEURL + '/filtroPersonalSintomasAtendido',{
            method: 'POST',
            body: JSON.stringify({
                division: division,
                area: areaFilter,
