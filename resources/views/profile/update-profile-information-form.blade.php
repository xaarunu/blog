<x-jet-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        @if (Laravel\Jetstream\Jetstream::managesProfilePhotos())
            <div x-data="{photoName: null, photoPreview: null}" class="col-span-6 sm:col-span-4">
                ...
                <div class="mt-2" x-show="! photoPreview">
                    <img src="{{ $this->user->profile_photo_url }}" alt="{{ $this->user->rpe }}" class="rounded-full h-20 w-20 object-cover">
                </div>
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-jet-input id="rpe" type="text" class="mt-1 block w-full" wire:model.defer="state.rpe" autocomplete="rpe" disabled />
