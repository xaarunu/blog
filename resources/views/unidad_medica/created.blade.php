<x-app-layout>
    ...
    <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-6 py-4 mt-4 mb-4 ml-11"
        ...
        <form action="{{ route('unidad_medica.store') }}" method="POST">
            @csrf
            <div class="mb-3">
            ...
            <button type="submit" class="btn btn-success bg-green-500 hover:bg-green-600">Crear Unidad Médica</button>
        </form>
