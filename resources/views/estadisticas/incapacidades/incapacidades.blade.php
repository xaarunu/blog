<x-app-layout>
    ...
    <div class="col-sm-12 mb-4">
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg mx-auto" style="width: 85%; padding: 40px 40px 40px 50px;">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4 md:gap-8 mt-5 mb-2 mx-7">
                ...
                <div class="grid grid-cols-1">
                    ...
                    <select id="ramo" name="ramo_filtro"
                        class="py-2 px-3 rounded-lg border-2 border-green-600 mt-1 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent">
                        <option value="0" style='color: blue;'>Todos</option>
                ...
                <div class="grid grid-cols-1">
                    <label class="block uppercase md:text-sm text-xs text-gray-500 font-semibold">Días Autorizados:</label>
                    <select id="dias_autorizados" name="dias_autorizados"
                        class="py-2 px-3 rounded-lg border-2 border-green-600 mt-1 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent">
                        <option value="0">Todos</option>
                        <option value="1">1 día</option>
                        <option value="2">2 días</option>
                        <option value="3">3 días</option>
                        <option value="4"> Mas de 3 días</option>
                    </select>
                </div>
                <div>
...
<script>
    ...
    enviar.addEventListener('click', (e) => {
        ...
        var diasAutorizados = document.getElementById('dias_autorizados').value;

        const url = "{{ route('estadisticas.incapacidades.filtrarArea') }}";
        const data = {
            area: area,
