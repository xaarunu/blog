<x-app-layout>
    ...
    <div class="py-12">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <form action="{{ route('llenar-datos-personales.store') }}" method="POST" class="formEnviar" enctype="multipart/form-data">
            @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 mt-5 mx-7">
                    ...
                    <div class="grid grid-cols-1">
                        ...
                        <input name="email" class=" @error('email') is-invalid @enderror py-2 px-3 rounded-lg border-2 border-green-600 mt-1 focus:outline-none focus:ring-2 focus:ring-green-700 focus:border-transparent" type="text" value="{{old('rpe')}}" required/>
                        @error('email')
                    ...
                    <div class="grid grid-cols-1">
                        ...
                        <input name="nombre" class="py-2 px-3 rounded-lg border-2 border-green-600 mt-1 focus:outline-none focus:ring-2 focus:ring-green-700 focus:border-transparent" type="text" value="{{old('rpe')}}" required/>
                    </div>
                    <div class="grid grid-cols-1">
                        <label class="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold">Apellido Paterno:</label>
                        <input name="paterno" class="py-2 px-3 rounded-lg border-2 border-green-600 mt-1 focus:outline-none focus:ring-2 focus:ring-green-700 focus:border-transparent" type="text" value="{{old('rpe')}}" required/>
                    </div>
                    <div class="grid grid-cols-1">
                        <label class="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold">Apellido Materno:</label>
                        <input name="materno" class="py-2 px-3 rounded-lg border-2 border-green-600 mt-1 focus:outline-none focus:ring-2 focus:ring-green-700 focus:border-transparent" type="text" value="{{old('rpe')}}" required/>
                    </div>
                    <div class="grid grid-cols-1">
                        <label class="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold">Fecha de Ingreso:</label>
                        <input name="ingreso" type="date" class="py-2 px-3 rounded-lg border-2 border-green-600 mt-1 focus:outline-none focus:ring-2 focus:ring-green-700 focus:border-transparent" type="text" value="{{old('rpe')}}" required/>
                    </div>
                    <div class="grid grid-cols-1">
