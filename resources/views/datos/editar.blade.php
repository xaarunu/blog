            ...
            @csrf --}}
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 mt-5 mx-7">
                    ...
                    <div class="grid grid-cols-1">
                        ...
                        <input name="rpe" value="{{$datos->rpe}}" class=" @error('rpe') is-invalid @enderror py-2 px-3 rounded-lg border-2 border-green-600 mt-1 focus:outline-none focus:ring-2 focus:ring-green-700 focus:border-transparent" type="text" value="{{old('rpe')}}" required/>
                        @error('rpe')
                    ...
                    <div class="grid grid-cols-1">
                        ...
                        <input name="nombre" value="{{$datos->nombre}}" maxlength="191" class="py-2 px-3 rounded-lg border-2 border-green-600 mt-1 focus:outline-none focus:ring-2 focus:ring-green-700 focus:border-transparent" type="text" value="{{old('nombre')}}" required/>
                    </div>
                    <div class="grid grid-cols-1">
                        <label class="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold">Apellido Paterno:</label>
                        <input name="paterno" value="{{$datos->paterno}}" maxlength="191" class="py-2 px-3 rounded-lg border-2 border-green-600 mt-1 focus:outline-none focus:ring-2 focus:ring-green-700 focus:border-transparent" type="text" value="{{old('paterno')}}" required/>
                    </div>
                    <div class="grid grid-cols-1">
                        <label class="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold">Apellido Materno:</label>
                        <input name="materno" value="{{$datos->materno}}" maxlength="191" class="py-2 px-3 rounded-lg border-2 border-green-600 mt-1 focus:outline-none focus:ring-2 focus:ring-green-700 focus:border-transparent" type="text" value="{{old('materno')}}" required/>
                    </div>
                    <div class="grid grid-cols-1">
                        <label class="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold">Fecha de Ingreso:</label>
                        <input name="ingreso" value="{{$datos->ingreso}}" min="1900-01-01" max="{{date('Y-m-d');}}" type="date" class="py-2 px-3 rounded-lg border-2 border-green-600 mt-1 focus:outline-none focus:ring-2 focus:ring-green-700 focus:border-transparent" type="text" value="{{old('ingreso')}}" required/>
                    </div>
                    <div class="grid grid-cols-1">
                ...
                <div class='flex items-center justify-center  md:gap-8 gap-4 pt-5 pb-5'>
                    ...
                    <!-- botón guardar -->
                    <button type="submit" class="bg-purple-500 hover:bg-green-700 rounded-lg shadow-xl font-medium text-black px-4 py-2">Guardar</button>
                </div>
            </form>
